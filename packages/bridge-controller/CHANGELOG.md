...
- Bump `@metamask/assets-controller` from `^4.0.0` to `^5.0.1` ([#8406](https://github.com/MetaMask/core/pull/8406), [#5](https://github.com/MetaMask/core/pull/5))
...
- Bump `@metamask/transaction-controller` from `^64.0.0` to `^64.3.0` ([#8432](https://github.com/MetaMask/core/pull/8432), [#8447](https://github.com/MetaMask/core/pull/8447), [#5](https://github.com/MetaMask/core/pull/5))
- Bump `@metamask/base-controller` from `^9.0.1` to `^9.1.0` ([#8457](https://github.com/MetaMask/core/pull/8457))
- Bump `@metamask/assets-controllers` from `^103.1.1` to `^104.0.0` ([#5](https://github.com/MetaMask/core/pull/5))
